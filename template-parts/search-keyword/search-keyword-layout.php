...
?>
    <form role="search" method="get" class="flex justify-center w-full mb-6 md:py-3" action="<?php echo home_url() ?>">
        <input id="search-by-keyword" type="search" class="p-3 w-full md:w-2/3 h-12 rounded-none text-lg" placeholder="¿Qué estás buscando?" value="<?php echo get_query_var('s') ?>" name="s" tabindex="-1">
